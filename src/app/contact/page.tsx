        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#153420] text-white text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 text-base">
              Ready to plan your Marayoor trip? We&apos;re here every day to help.
            </p>
          </div>
        </section>
            ...
            <div>
              ...
              <div className="space-y-4 mb-10">
                {[
                  ...
                  { icon: "fa-envelope",    label: "Email",      value: "info@marayoor.in",  href: "mailto:info@marayoor.in",    sub: "Reply within 2 hours" },
              ...
              <div className="relative rounded-[2rem] overflow-hidden h-52 bg-gray-100 border border-gray-200">
                <img src="/jeep/jeep 9.png" alt="Marayoor location" className="w-full h-full object-cover opacity-60" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <a href="https://maps.google.com/?q=Marayoor+Kerala" target="_blank" rel="noopener noreferrer"
              ...
              {sent ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-16 gap-4">
                  ...
                  <p className="text-gray-500 max-w-xs text-sm">
                    Our team will reach out within 2 hours. We look forward to helping you plan your Marayoor trip!
                  </p>
                </div>
              ) : (
                <>
